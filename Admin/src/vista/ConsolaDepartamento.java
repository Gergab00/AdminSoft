...
public class ConsolaDepartamento {

	private JDialog frmDepartamentos;
	 ...
	 */
	public ConsolaDepartamento(JFrame frame, JDialog dialog) {
	...
	private void initialize(JFrame frame, JDialog dialog) {
		if(frame != null)frmDepartamentos = new JDialog(frame, true);
		else frmDepartamentos = new JDialog(dialog, true);		
		frmDepartamentos.setTitle("Departamentos");
		frmDepartamentos.setResizable(false);
		frmDepartamentos.setBounds(100, 100, 450, 300);
		frmDepartamentos.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

		JPanel panelCentral = new JPanel();
		panelCentral.setMinimumSize(new Dimension(450, 150));
		frmDepartamentos.getContentPane().add(panelCentral, BorderLayout.CENTER);
		...
		frmDepartamentos.getContentPane().add(scrollPane, BorderLayout.SOUTH);

		list = new JList();
		list.setBorder(new LineBorder(new Color(0, 0, 0), 1, true));
		list.setListData(new DatosLista().getVector(InterfaceDepartamentosGrupos.DEPTO));
		...
		frmDepartamentos.setJMenuBar(menuBar);
	...
	/**
	 * @return the frmDepartamentos
	 */
	public JDialog getFrmDepartamentos() {
		return frmDepartamentos;
	}

	/**
	 * @param frmDepartamentos the frmDepartamentos to set
	 */
	public void setFrmDepartamentos(JDialog frmDepartamentos) {
